...
static void gpio_setup(void)
{
    ...
    gpio_set_mode(GPIOB, GPIO_MODE_INPUT, GPIO_CNF_INPUT_PULL_UPDOWN, GPIO15 | GPIO4 | GPIO5 | GPIO6 | GPIO7 | GPIO8 | GPIO9);
    gpio_set_mode(GPIOB, GPIO_MODE_OUTPUT_10_MHZ, GPIO_CNF_OUTPUT_PUSHPULL, GPIO12 | GPIO13 | GPIO14);

	gpio_set(GPIOB, GPIO15 | GPIO4 | GPIO5 | GPIO6 | GPIO7 | GPIO8 | GPIO9);
